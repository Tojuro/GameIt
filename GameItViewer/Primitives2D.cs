...
namespace GameItViewer
{
    ...
    public static class Primitives2D
    {
        ...
        #region FillRectangleRound

        public static void FillRectangleRound(this SpriteBatch spriteBatch, Rectangle rec, Color color)
        {
            FillRectangle(spriteBatch, rec, color);
            DrawCircle(spriteBatch, rec.X, rec.Y + rec.Height/2, rec.Height/2, 36, color, rec.Height/2);
